...
export const EXPANDED_KEYWORDS = [
  ...
  // 시니어 & 노년층 (9개)
  '생활 정보', '건강관리', '사이다 반전', '지혜', '인생 사연', '감동 사연', '고부 갈등', '국뽕', '실화',
...
export const KEYWORD_CATEGORIES = {
  ...
  '시니어 & 노년층': ['생활 정보', '건강관리', '사이다 반전', '지혜', '인생 사연', '감동 사연', '고부 갈등', '국뽕', '실화'],
  '트렌드 & 밈': ['썰', '밈', '힐링', '커뮤니티', '짤'],
  '하이라이트 & 편집 콘텐츠': ['모음', '플리', '플레이 리스트', '짜집기']
};
